...
import CosmonautHelloCosmonautHelloHello from './cosmonaut/hello/cosmonaut.hello.hello'
...
export default { 
  CosmonautHelloCosmonautHelloHello: load(CosmonautHelloCosmonautHelloHello, 'cosmonaut.hello.hello'),

...
import CosmonautWayneCosmonautWayneWayne from './cosmonaut/wayne/cosmonaut.wayne.wayne'
...
export default { 
  CosmonautWayneCosmonautWayneWayne: load(CosmonautWayneCosmonautWayneWayne, 'cosmonaut.wayne.wayne'),
